...
const updateUser = async (req, res, next) => {
  ...
  try {
    ...
    res.status(400).send(JSON.stringify({ message: "Ошибкаа обновления пользователя" }));
  }
};
...
module.exports = {findAllUsers, createUser, findUserById, updateUser, deleteUser, checkEmptyNameAndEmailAndPassword, hashPassword, checkIsUserExists};
